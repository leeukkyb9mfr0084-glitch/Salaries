...
SIMULATION_DB_FILE = os.path.join(SIMULATION_DB_DIR, "simulation_kranos_data_renewals.db")
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            cursor.execute("DELETE FROM members WHERE client_name LIKE 'SimRenewUser_%'")
